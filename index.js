...
const setTimePromise = (timer, message) => {
    ...
    if (selectedOperation === "Balance Inquiry") {
        ...
        if (selectedOperation === "Cash Withdrawal") {
            ...
            while (!isAmount500) {
                ...
                if (!isAmount500) {
                    console.log("Sorry the amount entered is not in 500, 1000 or 5000 rupees note");
                }
                else {
        ...
        if (amount > balance) {
            ...
            balance -= amount;
            await loading(`Transaction succeeded. Your remaining balance is ${balance}`);
        }
    }
